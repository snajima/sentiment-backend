...
from entries.views import EntriesView, EntryView, DateEntryView, RangeEntryView
from persons.views import AuthenticateView, DeveloperView, MeView
...
urlpatterns = [
    ...
    path("entries/user/<int:id>/range/", RangeEntryView.as_view(), name="entry"),
